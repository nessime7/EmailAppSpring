...
//
//    private final EmailService emailService = new EmailService(repository, companyRepository, departmentRepository);
//
//    @Test
...
//
//        // when
//        var result = emailService.addDepartment(companyId, new DepartmentRequest(name, budget));
//
//        // then
...
//
//        // when
//        var result = emailService.addManager(companyId, departmentId, new ManagerRequest(firstName, lastName));
//
//        // then
